...
/* harmony import */ var _import_jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./import-jquery */ "./resources/js/import-jquery.js");
...
/* harmony import */ var mobile_detect__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! mobile-detect */ "./node_modules/mobile-detect/mobile-detect.js");
/* harmony import */ var mobile_detect__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(mobile_detect__WEBPACK_IMPORTED_MODULE_6__);
...
$(document).ready(function () {
  ...
  var accordionContainer = $(".js-accordion-header-to-hide");
  var catalogContainer = $(".js-catalog-action");
  var selectContainer = $(".js-select__header");

  if (window.innerWidth >= 1200) {
    $(document).on("mouseup", function (e) {
      var accordion = $(".js-accordion-body-to-hide");
      var catalog = $(".js-main-list");
      var select = $(".js-select__body");

      if (accordionContainer.has(e.target).length === 0 && accordion.has(e.target).length === 0) {
        $(accordion).slideUp();
      ...
      if (selectContainer.has(e.target).length === 0 && select.has(e.target).length === 0) {
  ...
  $(window).on("resize", function () {
    $(".js-footer .js-accordion").each(function () {
      ...
      var header = $(this).find(".js-accordion-header");
  ...
  $(".js-basket-popup-remove").on("click", function () {
    var elem = $(".js-cart-button .js-cart-count");
    var count = +elem.text();
  ...
  $(".js-select").on("click", function () {
    var selectBody = $(this).find(".js-select__body");
...
/* harmony default export */ __webpack_exports__["default"] = (window.$ = window.jQuery = (jquery__WEBPACK_IMPORTED_MODULE_0___default()));
...
/******/ 	__webpack_require__.O(undefined, ["css/catalog","css/home"], function() { return __webpack_require__("./resources/js/app.js"); })
/******/ 	__webpack_require__.O(undefined, ["css/catalog","css/home"], function() { return __webpack_require__("./resources/css/home.scss"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/catalog","css/home"], function() { return __webpack_require__("./resources/css/catalog.scss"); })
