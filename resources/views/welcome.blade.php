  ...
  <header class="header">
    <div class="wrapper">
      <div class="container-fluid px-0">
        <div class="row mx-0 mb-3 align-items-center justify-content-between js-row-1">
          <div class="col-xxl-3 col-1 mr-xxl-5 mr-6 pl-0 js-logo-wrap">
            <svg class="logo">
          ...
          <div class="col mr-xxl-5 mr-0 d-flex align-items-center justify-content-between js-menu-wrap">
            <nav class="menu js-menu">
              <div class="menu__item  js-menu-item active">
            ...
            <div class="phones js-accordion">
              <div class="phones__top js-accordion-header">
                <span class="phones__text">+38 068 000 00 00</span>
                <div class="arrow arrow-down"></div>
              </div>
              <div class="phones__body js-accordion-body">
                <span class="phones__text phones__body-text">+38 068 000 00 01</span>
                <span class="phones__text phones__body-text">+38 068 000 00 02</span>
                <span class="phones__text phones__body-text">+38 068 000 00 03</span>
              </div>
            </div>
          </div>

          <div class="col-xl-2 col-3 px-0 d-flex justify-content-end align-items-center">
            <div class="menu mr-xxl-6 mr-0">
        ...
        <div class="row mx-0 js-row-2">
          <div class="col-xl-3 col-lg-4 col-5 mr-xl-5 mr-0 pl-0">
            <div class="catalog">
          ...
          <div class="col-xl-2 col-3 px-0 d-flex align-items-center js-user-button-wrap">
  ...
  <main class="main">
    ...
    @php
      $goods = [
          ...
          ['id' => 2, 'title' => 'Ружье Mossberg 590M Mag-Fed к.12 18.5" Synthetic1', 'label' => 'special', 'label-text' => 'Акция', 'icons' => ['wish', 'compare'], 'rating' => '5', 'votes-count' => '2', 'price' => '32 509', 'new-price' => '27 632.65'],
          ['id' => 3, 'title' => 'Ружье Mossberg 590M Mag-Fed к.12 18.5" Synthetic2', 'label' => 'sale', 'label-text' => '-70%', 'icons' => ['wish', 'compare'], 'rating' => '3', 'votes-count' => '12', 'price' => '27 632.65'],
          ['id' => 4, 'title' => 'Ружье Mossberg 590M Mag-Fed к.12 18.5" Synthetic3', 'label' => 'top', 'label-text' => 'топ продаж', 'icons' => ['wish', 'compare', 'play'], 'rating' => '2', 'votes-count' => '46', 'price' => '32 509', 'new-price' => '27 632.65'],
          ...
          ['id' => 2, 'title' => 'Ружье Mossberg 590M Mag-Fed к.12 18.5" Synthetic5', 'label' => 'special', 'label-text' => 'Акция', 'icons' => ['wish', 'compare'], 'rating' => '4', 'votes-count' => '11', 'price' => '32 509', 'new-price' => '27 632.65'],
          ['id' => 3, 'title' => 'Ружье Mossberg 590M Mag-Fed к.12 18.5" Synthetic6', 'label' => 'sale', 'label-text' => '-40%', 'icons' => ['wish', 'compare'], 'rating' => '2', 'votes-count' => '12', 'price' => '32 509', 'new-price' => '27 632.65'],
          ['id' => 4, 'title' => 'Ружье Mossberg 590M Mag-Fed к.12 18.5" Synthetic7', 'label' => 'top', 'label-text' => 'топ продаж', 'icons' => ['wish', 'compare', 'play'], 'rating' => '5', 'votes-count' => '13', 'price' => '27 632.65'],
      ];
    @endphp

    @isset($goods)
      <section class="goods custom-scrollbar overflow-x-auto" data-scrollbar>
        <div class="container-fluid px-0 goods__outer">
          <div class="row flex-nowrap align-items-stretch goods__inner">
